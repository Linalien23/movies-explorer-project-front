...
function SavedMovies({ movieCards, onDeleteMovie, searchMovie, onShort, isShort, getSavedMovies, loggedIn, searchedMovie, isSearched, onSearched, onSetMessage, message }) {
